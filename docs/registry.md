...
| [docs/hosting-setup.md](hosting-setup.md) | GCS bucket setup, Cloudflare DNS, redirect rules, HTTPS, Cloud Run backend service, Cloudflare Worker routing | 1.1 | 2026-05-31 | Hosting infrastructure changes |
