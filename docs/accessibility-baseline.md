...
|---|---|---|---|---|
| `foreground` | `#edf4ff` | `#060816` | ~18.01:1 | ✅ AA, AAA |
| `foreground-muted` | `#9fb0cb` | `#060816` | ~9.06:1 | ✅ AA, AAA |
| `accent-cyan` | `#67e8f9` | `#060816` | ~13.74:1 | ✅ AA, AAA |
| `accent-magenta` | `#f472b6` | `#060816` | ~7.5:1 | ✅ AA, AAA |
| `foreground-muted` | `#9fb0cb` | `#0b1225` | ~8.47:1 | ✅ AA, AAA |
...
- [ ] All interactive elements meet 44×44px minimum touch target (WCAG 2.5.5 Target Size — Enhanced, Level AAA)
- [ ] Nav links use `min-h-10` (40px) — meets WCAG 2.2 SC 2.5.8 (Target Size — Minimum, Level AA);
  use `min-h-11` (≈44px) to also satisfy WCAG 2.5.5 (Level AAA) — flag for Phase 4 polish
...
- Nav link touch targets are `min-h-10` (40px); this satisfies WCAG 2.2 SC 2.5.8 (Target Size —
  Minimum, Level AA). To also meet WCAG 2.5.5 (Target Size — Enhanced, Level AAA), use
  `min-h-11` (≈44px) — revisit during Phase 4 polish.
